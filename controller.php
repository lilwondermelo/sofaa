...
class Controller {
	...
	public function getClientList($page) {
		...
		$this->authHeader = $this->account->getYcAuth();
		$args = array('page_size' => 1, 'page' => $page, "filters"=> array(array("type"=> "record","state" => array("records_count"=> array("from"=>1,"to"=> 99999), 'created' => array("from": "2021-11-01", "to": "2022-03-23")))));
		$this->method = 'POST';
