...
(select sum(case when r1.cost_end is null then r1.cost when r1.cost_end = 0 then r1.cost else r1.cost_end) from records r1 left join managers m3 on m3.yc_id = r1.manager_id
